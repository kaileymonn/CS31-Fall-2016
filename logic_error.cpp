...
int main()
{
	...
	double pctKeep = 100.0 * numberSurveyed / numKeep; //Error: replaced numKeep with numberSurveyed and numberSurveyed with numKeep
	double pctRefund = 100.0 * numberSurveyed / numRefund; //Error: replaced numRefund with numberSurveyed and numberSurveyed with numRefund
